...
const About = () => {
    return (
        <div
            className='flex flex-col align-center items-center py-28'
            style={{
        ...
        >
            ...
            <div className='flex flex-row align-center'>
                <div className='bg-purple text-white w-80 p-[50px] rounded-bl-2xl h-[80%] mb-10'>
                    <h2>
                        Education
                    </h2>
                ...
                <div className='bg-orange text-white w-80 p-[50px] rounded-b-2xl'>
                    <h2>
                        Campaigning
                    </h2>
                    <p className="text-base">
                ...
                <div className='bg-green text-white w-80 p-[50px] rounded-br-2xl h-[80%] mb-10'>
                    <h2>
                        Community
                    </h2>
                    <p className="text-base">
